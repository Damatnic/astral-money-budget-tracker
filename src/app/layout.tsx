  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        ...
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https:; img-src 'self' data: https:; font-src 'self' data: https: https://fonts.gstatic.com https://r2cdn.perplexity.ai; connect-src 'self' https:;" />
